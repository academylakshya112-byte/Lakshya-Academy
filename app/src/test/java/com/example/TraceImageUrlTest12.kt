...
class TraceImageUrlTest12 {
    ...
    fun runCompleteLayerTrace() = runBlocking {
        ...
        // Since ViewModel directly exposes the Room DB Flow as StateFlow, we can trace the exact list emitted
        val vmCourses = db.academyDao().getAllCoursesDirect()
        ...
        // Fetch videos if any to replicate real dashboard behavior
        val supabaseVideos = mutableListOf<SupabaseVideo>() 
